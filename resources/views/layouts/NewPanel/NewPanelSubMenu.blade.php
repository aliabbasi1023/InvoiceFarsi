<div class="align-items-start d-lg-none p-0" id="toggle_menu">
    <div class="row col-12 p-0 m-0">
        <div class="col-12" id="logo_farsi_toggle">
            <div class="col-12 row justify-content-center">
                <div class="col-4 p-0 m-0">
                    <img class="col-12" src="/NewPanel/assets/img/logo-farsi-1402.png" alt="">
                </div>
                <figcaption class="col-8 d-flex justify-content-center align-items-center m-0 p-0">
                    گروه صنایع غذایی فارسی
                </figcaption>
            </div>
        </div>

        <div class="line_box_t col-12">
            <span class="line_text_t">جستجو</span>
        </div>

        <div class="col-12 d-flex p-0 my-2" id="search_box_toggle">
            <div class="col-12 row justify-content-end">
                <!-- <i class="bi bi-search"></i> -->
                <input type="search" name="" id="inp_search_toggle" class="col-11 ps-2" placeholder="جستجو کنید">
            </div>
        </div>

        <div class="line_box_t col-12">
            <span class="line_text_t">فهرست</span>
        </div>
        <div class="pb-1 p-0" id="menu_box_toggle">
            <!-- ********* -->
            <!-- note: id accordion bayad ba data-bs-parent item ha yeki bashe  -->
            <!-- note: baraye kar kardan tag a bayad type="button" data-bs-toggle="collapse" pak she  -->
